...
static double run_case(bool enable_igs) noexcept
{
    ...
    // Disable channel so leakage dominates.
    ...
    // VAC branch current: real part corresponds to conductive leakage (in-phase with V).
