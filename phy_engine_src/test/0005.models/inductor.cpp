...
{
    {

        {
            ...
            auto [I1, I1_pos]{add_model(nl, ::phy_engine::model::inductor{.m_kZimag{1e-5}})};
            ...
            else
            {
                ...
                auto const c1_pin_view{I1->ptr->generate_pin_view()};
                ...
                ::fast_io::io::println("I1: VA=", ::fast_io::mnp::fixed(c1_V1), "V, VB=", ::fast_io::mnp::fixed(c1_V2), "V, V=", c1_V1 - c1_V2);
