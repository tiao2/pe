...
module top(input a, input b, output y);
  assign y = a & b;
    ...
    // Create port nodes in module port order: a, b, y.
    ...
    // Add external IO models.
    auto [in_a, pa] = ::phy_engine::netlist::add_model(nl, ::phy_engine::model::INPUT{.outputA = ::phy_engine::model::digital_node_statement_t::false_state});
    auto [in_b, pb] = ::phy_engine::netlist::add_model(nl, ::phy_engine::model::INPUT{.outputA = ::phy_engine::model::digital_node_statement_t::false_state});
    auto [out_y, py] = ::phy_engine::netlist::add_model(nl, ::phy_engine::model::OUTPUT{});
    (void)pa;
    (void)pb;
    (void)py;
    ...
    (void)in_b->ptr->set_attribute(0, dv(::phy_engine::model::digital_node_statement_t::true_state));
    c.digital_clk();
